...
const key = '74JukLK2UunYmn7okZUeSum4eXEAOzlq';
let url;
...
function fetchResults(event) {
    ...
    //add start and end date if needed (2025-03-25) (but we don't want the dashes)
    if(startDate.value !== ""){
      //url and url plus
...
function displayResults(json) {
    ...
    if (articles.length === 0) {
        ...
        for(let i = 0; i < articles.length; i++) {
            ...
            link.textContent = articles[i].headline.main; // refer to json object
            //console.log(link);
            ...
            console.log(article);
            // innject completed article element into page
