...
There are a number of functions that are included with most modern 
browsers - the replace() function is just one of many */
...
function makeH1Red() {
  ...
  //if a css property is hyphenated, it must be camelCased in JavaScript
  h1.style.color ="red";
};
makeH1Red();
...
console.log(lunch);
lunchTwo = lunchArray.join(" - ");
console.log(lunchTwo);
