	...
	const element = document.querySelector("em");	
		// STEP 3: Assign a click event listener to the above element, and include a reference to the function to be invoked
	      //first is argument is event type, second what we are gonna do
    element.addEventListener("click", updateName); //updateName is made up, we're not calling the fucntion, only referring it
      ...
      let firstname = prompt("what is your name: ") // < is the equivelent of console.readline
